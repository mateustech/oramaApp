...
export default function Conservador({navigation}) {
  return (
    <SafeAreaView>
            ...
            <View style={styles.btn}>
              <View style={styles.img}>
                <Image
                  ...
                  source={require('../../assets/investidor_conservador.png')}
                />
              </View>
              <TouchableOpacity
                style={{
                ...
                onPress={() => Alert.alert('CONSERVADOR')}>
                {/* <Image
                  style={styles.imgBtn}
                  source={require('../../assets/cofrinho2.png')}
                /> */}
                <Text style={styles.txtBtn}>CONSERVADOR</Text>
                <Text style={styles.txt}>
                  É aquele que procura aplicações de baixo risco. A segurança
